      ...
      <main className="grow">
        ...
        <section>
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="pb-8 pt-28 md:pb-16 md:pt-36">
                  ...
                  <div className="pb-8">
                    ...
                    <div className="flex items-center justify-end space-x-4">
                      ...
                      <ul className="inline-flex space-x-3">
                        <li>
                          <a
                            className="flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 transition duration-150 ease-in-out hover:bg-indigo-500 hover:text-white"
                            href="#0"
                            aria-label="Twitter"
                          >
                            <svg
