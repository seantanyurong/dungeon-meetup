  ...
  const playgroupList2 = [
    {
      ...
      description:
        "A group of investment bankers who have been playing competitively since 2018. Looking for a few more players to join us in honing the meta.",
      name: "Constructed All Stars",
      city: "Singapore",
      lgs: false,
      physical: "Physical",
      image: card7,
    },
    {
      ...
      formats: ["EDH"],
      description:
        "Hi, we're 4 guys from China, looking for another player to join us. You don't have to be from China, but ideally Chinese speaking. Play on Spelltable.",
      name: "Chinese Speakers Only",
      city: "Remote",
      lgs: false,
      physical: "Remote",
      image: card8,
    },
    {
      ...
      formats: ["cEDH"],
      description:
        "Developers from a wide variety of tech companies. We're looking to pull together a group in Singapore so we can complain about our bosses while we game.",
      name: "Developers + cEDH",
      city: "Singapore",
      lgs: false,
      physical: "Physical",
      image: card9,
    },
    {
      ...
      formats: [],
      description:
        "The premier LGS in Singapore. We host multiple games every week, and a range of events throughout the month. Big place to play for free everyday.",
      name: "Dungeon House",
      city: "Singapore",
      lgs: true,
      physical: "Physical",
    ...
    },
    {
      ...
      formats: ["EDH", "Limited"],
      description:
        "Welcome to Idaho, land of the potatoes. We are Boise's main Magic the Gathering playgroup, welcoming players from all walks of life.",
      name: "Potato Land",
      city: "Boise",
      lgs: false,
      physical: "Physical",
    ...
    },
    {
      ...
      formats: [],
      description:
        "A competitive Magic the Gathering focussed LGS based in JB. We mainly play limited, and have pods firing off every other day.",
      name: "Mana Geyser",
      city: "Johor Bahru",
      lgs: true,
      physical: "Physical",
